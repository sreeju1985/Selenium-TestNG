...
import com.flight.qa.utilities.SeleniumActions;
import com.flight.qa.utilities.TestUtils;
import com.flight.qa.utilities.WebDriverListener;
...
public class TestBase {
	...
	private static WebDriver getDriver(String browserName) {
		if (browserName.equalsIgnoreCase("chrome")) {
			...
			System.setProperty("webdriver.gecko.driver", "C://Users/sreeju//geckodriver.exe");
